...
swagger.title=蜜雪冰城项目资源看板
swagger.description=Starter for swagger 1.x
swagger.version=1.4.0.RELEASE
swagger.license=Apache License, Version 1.0
swagger.licenseUrl=https://www.mxbc.com
swagger.termsOfServiceUrl=https://www.mxbc.com
swagger.contact.name=
swagger.contact.url=
swagger.contact.email=sunwei@mxbc.com
...
swagger.docket.aaa.termsOfServiceUrl=http://mxbc.com
swagger.docket.aaa.contact.name=mxbc
swagger.docket.aaa.contact.url=http://mxbc.com
swagger.docket.aaa.contact.email=sunwei@mxbc.com
...
swagger.docket.bbb.basePackage=com.mxbc
```
