...
import com.cloud.server.api.properties.SwaggerAuthorizationProperties;
...
/**
 * @className: SwaggerAuthorizationConfiguration
 * @description: securitySchemes 支持方式之一 ApiKey
 * @author: sw
 * @date: 2021/8/30
 **/
@Configuration
